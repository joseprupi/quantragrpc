...
#ifndef FLATBUFFERS_GENERATED_RESPONSES_QUANTRA_RESPONSES_H_
#define FLATBUFFERS_GENERATED_RESPONSES_QUANTRA_RESPONSES_H_
...
struct FixedRatePricingResponse;
struct FixedRatePricingResponseBuilder;
...
template<> struct FlowTraits<quantra::responses::FlowInterest> {
  static const Flow enum_value = Flow_FlowInterest;
};

template<> struct FlowTraits<quantra::responses::FlowPastInterest> {
  static const Flow enum_value = Flow_FlowPastInterest;
};

template<> struct FlowTraits<quantra::responses::FlowNotional> {
...
struct FlowInterest FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  quantra::responses::FlowType flow_type() const {
    return static_cast<quantra::responses::FlowType>(GetField<int8_t>(VT_FLOW_TYPE, 0));
  }
  double amount() const {
...
struct FlowInterestBuilder {
  ...
  void add_flow_type(quantra::responses::FlowType flow_type) {
...
inline flatbuffers::Offset<FlowInterest> CreateFlowInterest(
    ...
    quantra::responses::FlowType flow_type = quantra::responses::FlowType_Interest,
    double amount = 0.0,
...
inline flatbuffers::Offset<FlowInterest> CreateFlowInterestDirect(
  ...
  return quantra::responses::CreateFlowInterest(
      _fbb,
      flow_type,
      amount,
...
inline flatbuffers::Offset<FlowPastInterest> CreateFlowPastInterestDirect(
  ...
  auto accrual_start_date__ = accrual_start_date ? _fbb.CreateString(accrual_start_date) : 0;
  auto accrual_end_date__ = accrual_end_date ? _fbb.CreateString(accrual_end_date) : 0;
  return quantra::responses::CreateFlowPastInterest(
      _fbb,
      flow_type,
      amount,
      accrual_start_date__,
...
inline flatbuffers::Offset<FlowNotional> CreateFlowNotionalDirect(
  ...
  return quantra::responses::CreateFlowNotional(
      _fbb,
      flow_type,
      date__,
      amount,
...
struct FixedRatePricingResponse FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef FixedRatePricingResponseBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_NPV = 4,
    VT_CLEAN_PRICE = 6,
    VT_DIRTY_PRICE = 8,
...
struct FixedRatePricingResponseBuilder {
  typedef FixedRatePricingResponse Table;
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_npv(float npv) {
    fbb_.AddElement<float>(FixedRatePricingResponse::VT_NPV, npv, 0.0f);
  }
  void add_clean_price(float clean_price) {
    fbb_.AddElement<float>(FixedRatePricingResponse::VT_CLEAN_PRICE, clean_price, 0.0f);
  }
  void add_dirty_price(float dirty_price) {
    fbb_.AddElement<float>(FixedRatePricingResponse::VT_DIRTY_PRICE, dirty_price, 0.0f);
  }
  void add_accrued_amount(float accrued_amount) {
    fbb_.AddElement<float>(FixedRatePricingResponse::VT_ACCRUED_AMOUNT, accrued_amount, 0.0f);
  }
  void add_yield(float yield) {
    fbb_.AddElement<float>(FixedRatePricingResponse::VT_YIELD, yield, 0.0f);
  }
  void add_accrued_days(int32_t accrued_days) {
    fbb_.AddElement<int32_t>(FixedRatePricingResponse::VT_ACCRUED_DAYS, accrued_days, 0);
  }
  void add_macaulay_duration(float macaulay_duration) {
    fbb_.AddElement<float>(FixedRatePricingResponse::VT_MACAULAY_DURATION, macaulay_duration, 0.0f);
  }
  void add_modified_duration(float modified_duration) {
    fbb_.AddElement<float>(FixedRatePricingResponse::VT_MODIFIED_DURATION, modified_duration, 0.0f);
  }
  void add_convexity(float convexity) {
    fbb_.AddElement<float>(FixedRatePricingResponse::VT_CONVEXITY, convexity, 0.0f);
  }
  void add_bps(float bps) {
    fbb_.AddElement<float>(FixedRatePricingResponse::VT_BPS, bps, 0.0f);
  }
  explicit FixedRatePricingResponseBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  flatbuffers::Offset<FixedRatePricingResponse> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = flatbuffers::Offset<FixedRatePricingResponse>(end);
    return o;
  }
};

inline flatbuffers::Offset<FixedRatePricingResponse> CreateFixedRatePricingResponse(
    flatbuffers::FlatBufferBuilder &_fbb,
    float npv = 0.0f,
    ...
    float bps = 0.0f) {
  FixedRatePricingResponseBuilder builder_(_fbb);
...
inline bool VerifyFlow(flatbuffers::Verifier &verifier, const void *obj, Flow type) {
  switch (type) {
    ...
    case Flow_FlowInterest: {
      auto ptr = reinterpret_cast<const quantra::responses::FlowInterest *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Flow_FlowPastInterest: {
      auto ptr = reinterpret_cast<const quantra::responses::FlowPastInterest *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case Flow_FlowNotional: {
      auto ptr = reinterpret_cast<const quantra::responses::FlowNotional *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
#endif  // FLATBUFFERS_GENERATED_RESPONSES_QUANTRA_RESPONSES_H_
