...
var FutureHelper = /** @class */ (function () {
    ...
    FutureHelper.prototype.serialize = function () {
        return this.bb.bytes();
    };
    FutureHelper.deserialize = function (buffer) {
        return FutureHelper.getRootAsFutureHelper(new flatbuffers.ByteBuffer(buffer));
    };
    return FutureHelper;
}());
