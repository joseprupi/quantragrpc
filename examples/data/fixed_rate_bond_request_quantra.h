...
inline structs::PriceFixedRateBondRequest request_bond()
{
    ...
    structs::Point deposit_zc1y_point;
    ...
    structs::TermStructure term_structure;
    ...
    structs::PriceFixedRateBond price_fixed_rate_bond;
    price_fixed_rate_bond.fixed_rate_bond = bond;
    strcpy(price_fixed_rate_bond.discounting_curve, "depos");

    std::vector<structs::PriceFixedRateBond> bonds;
    bonds.push_back(price_fixed_rate_bond);

    std::vector<structs::TermStructure> term_structures;
