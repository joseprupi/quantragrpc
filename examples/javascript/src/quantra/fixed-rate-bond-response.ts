...
export class FixedRateBondResponse {
  ...
  static addYield(builder: flatbuffers.Builder, yield_: number) {
    builder.addFieldFloat64(4, yield_, 0.0);
  }
  ...
  static createFixedRateBondResponse(builder: flatbuffers.Builder, npv: number, cleanPrice: number, dirtyPrice: number, accruedAmount: number, yield_: number, accruedDays: number, macaulayDuration: number, modifiedDuration: number, convexity: number, bps: number, flowsOffset: flatbuffers.Offset): flatbuffers.Offset {
    ...
    FixedRateBondResponse.addYield(builder, yield_);
